...
if DevRio:get(Raumo.."Rio:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevRio:sadd(Raumo.."Rio:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevRio:get(Raumo.."Rio:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
RaumoName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if RaumoName then 
RaumoNames = DevRio:smembers(Raumo.."Rio:Mute:Names"..msg.chat_id_) or ""
if RaumoNames and RaumoNames[1] then 
for i=1,#RaumoNames do 
if RaumoName:match("(.*)("..RaumoNames[i]..")(.*)") then 
...
DevRio:set(Raumo.."Rio:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevRio:del(Raumo.."Rio:Lock:MuteNames"..msg.chat_id_)
end
end
end
